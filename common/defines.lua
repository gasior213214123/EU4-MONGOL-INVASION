...
NAI = {
	...
	PEACE_TERMS_TRIBUTARY_BASE_MULT = 0, -- Multiplies with strategic interest of making them our Tributary
	...
	DIPLOMATIC_ACTION_TRIBUTARY_ACCEPTANCE_PER_DEVELOPMENT = -50,	-- AI scoring for accepting becoming a tributary state per raw development
...
NNationDesigner = {
	...
	MAX_DISTANCE_TO_OWNER_AREA = -1,
	MAX_DISCOVERED_PROVINCE_DISTANCE = -1,
